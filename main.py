...
def main():
    new_title = '<p style="font-size: 42px; color: #3498db; font-weight: bold; text-align: center; line-height: 1.5;">Object Detection Using Yolo V3</p>'
    read_me_0 = st.markdown(new_title, unsafe_allow_html=True)
    new_title9 = '<p style="font-size: 42px; color: #3498db; font-weight: bold; text-align: center; line-height: 1.5;">Project Developed By</p>'
    read_me_0 = st.markdown(new_title9, unsafe_allow_html=True)
    new_subtitle6 = '<p style="font-size: 22px;  text-align: center;"> Armughan ul Haq Bazigh FA20-BSCS-025 </p>'
    read_me = st.markdown(new_subtitle6, unsafe_allow_html=True)
    new_subtitle5 = '<p style="font-size: 22px ;  text-align: center;">Hassnain Haider FA20-BSCS-012</p>'
    read_me_0 = st.markdown(new_subtitle5, unsafe_allow_html=True)
